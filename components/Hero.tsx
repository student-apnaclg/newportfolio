    ...
    return (
        <div className='pb-20 pt-36'>
            <div>
                ...
                w-[50vh]" fill="purple"/>
                <Spotlight className="-top-40 left-80 h-[80vh] 
                w-[50vh]" fill="blue"/>
            </div>
            ...
            <div className="flex justify-center relative my-20 z-10 flex-wrap">
                <div className="w-max[89vw] md:max-w-2xl lg:max-w-[69vw] flex flex-wrap col items-center justify-center">
                    ...
                    <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
                        Hi,I&apos;m Nandini , a Next.js Devloper based in India.
                    </p>
